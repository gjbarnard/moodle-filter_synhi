...
$string['generalinformation'] = 'Use of the \'pre\' tag only for highlighting code has been removed, please use \'code\' instead and surround with a \'pre\' tag for multiple line code.  The \'<\' and \'>\' symbols seem to be problematic within in a \'code\' tag when they resemble a tag, change them to \'<i>(amphersand)</i>lt;\' and \'<i>(amphersand)</i>gt;\' respectively for your code - here <i>(amphersand)</i> means \'&\'.';
