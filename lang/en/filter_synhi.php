...
// Information.
$string['brokenmarkup'] = 'The module markup is broken, highlighting will be wrong.';
$string['enlighterinformation'] = 'Surround your code with the \'code\' tag.  Enlighter will attempt to workout the language.  But you can specify it by adding the \'data-enlighter-language\' attribute to the \'code\' tag with the value of the language, such as \'data-enlighter-language="java"\'.  So the desired text in the brackets for:<br><ul><li>Assembly (assembly, asm)</li><li>AVR Assembly (avrassembly, avrasm)</li><li>C/C++ (c,cpp, c++)</li><li>C# (csharp)</li><li>CSS (css)</li><li>Cython (cython)</li><li>CordPro (cordpro)</li><li>diff (diff)</li><li>Dockerfile (docker, dockerfile)</li><li>Generic (generic, standard) - default highlighting scheme</li><li>Groovy (groovy)</li><li>Go (go, golang)</li><li>HTML (html)</li><li>Ini (ini, conf)</li><li>Java (java)</li><li>Javascript (js, javascript, jquery, mootools, ext.js)</li><li>JSON (json)</li><li>Kotlin (kotlin)</li><li>LESS (less)</li><li>LUA (lua), Markdown (gfm, md, markdown)</li><li>Matlab/Octave (octave, matlab)</li><li>NSIS (nsis)</li><li>PHP (php)</li><li>Powerhsell (powershell)</li><li>Prolog (prolog)</li><li>Python (py, python)</li><li>PureBasic (purebasic, pb)</li><li>RAW (raw) - raw code without highlighting with EnlighterJS container styles!</li><li>Ruby (ruby)</li><li>Rust (rust)</li><li>SCSS (scss, sass)</li><li>Shellscript (shell, bash)</li><li>SQL (sql)</li><li>Squirrel (squirrel)</li><li>Swift (swift)</li><li>Typescript (typescript)</li><li>VHDL (vhdl)</li><li>VisualBasic (visualbasic, vb)</li><li>Verilog (verilog)</li><li>XML (xml)</li><li>YAML (yaml)</li></ul>';
$string['generalinformation'] = 'Use of the \'pre\' tag for highlighting code has been removed, please use \'code\' instead and surround with a \'pre\' tag if you wish.';
