...
$string['generalinformation'] = 'Use of the \'pre\' tag only for highlighting code has been removed, please use \'code\' instead and surround with a \'pre\' tag for multiple line code.';
